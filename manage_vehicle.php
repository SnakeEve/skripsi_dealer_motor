            ...
            <form>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label>SP ID</label>
                    <select class="form-control" id="vehicle_select">
                      <option>---option---</option>
                    </select>
                  </div>
                </div>
  ...
  <script type="text/javascript">
    ...
    $( document ).ready(function() {
      ...
      let buttons = '<div class="btn-group">'+
                      ...
                      '<button type="button" class="btn btn-flat btn-warning" id="btn_brand">Vehicle Brand</button>'+
                      '<button type="button" class="btn btn-flat btn-secondary" id="btn_type">Vehicle Type</button>'+
                    '</div>';
      ...
      $('#vehicle_type_select').select2({
        ajax: {
          url: 'mock/MOCK_DATA_VEHICLE_TYPE.json',
          theme: 'bootstrap4',
          delay: 250,
          dataType: 'json',
      ...
      $('#vehicle_brand_select').select2({
        ajax: {
          url: 'mock/MOCK_DATA_VEHICLE_BRAND.json',
          theme: 'bootstrap4',
          delay: 250,
          dataType: 'json',
          // data: function (params) {
    ...
    function call_datatable_price(id) {
      datatable_price = $('#data_price').DataTable({
        ...
        responsive: true,
        ajax: {
          "url": "mock/MOCK_DATA_VEHICLE_PRICE.json", //take the id
          "type": "GET",
          "headers": {
            'Content-Type': 'application/json'
          },
