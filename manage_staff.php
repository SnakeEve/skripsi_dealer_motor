        ...
        columns: [
          {
            ...
            "render": function (data, type, row) {
              ...
              button_string += '<button type="button" class="btn btn-info btn-lg-block button_update" data-toggle="tooltip" title="Update" ><i class="fa fa-edit"></i></button> ';
              button_string += '<button type="button" class="btn btn-danger btn-lg-block button_delete" data-toggle="tooltip" title="Hapus" ><i class="fa fa-trash"></i></button> ';
              button_string += '</div>';
